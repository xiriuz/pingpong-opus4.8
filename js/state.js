...
function makePlayer(index,side,character,isAI){return {index,side,character,isAI,x:0,z:side*2.05,swingTime:0,cooldown:0,swingShot:{dirX:0,dirY:0,power:.5},pose:'idle'};}
function makeBall(){return {x:0,y:.18,z:-1.75,vx:0,vy:0,vz:0,spin:{x:0,y:0,z:0},active:false,lastHit:null,bounces:[0,0],netChecked:false};}
export function prepareServe(state){
  const p=state.players[state.server],b=state.ball;
  Object.assign(b,{x:p.x,y:.18,z:p.z+.46*(-p.side),vx:0,vy:0,vz:0,active:false,lastHit:null,bounces:[0,0],netChecked:false});
